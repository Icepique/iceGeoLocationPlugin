...
abstract class BaseiceModelGeoCityPeer
{
  ...
  const CLASS_DEFAULT = 'plugins.iceGeoLocationPlugin.lib.model.iceModelGeoCity';
  ...
  public static function populateObjects(PDOStatement $stmt)
  {
    ...
    $cls = iceModelGeoCityPeer::getOMClass(false);
  ...
  {
    return $withPrefix ? iceModelGeoCityPeer::CLASS_DEFAULT : iceModelGeoCityPeer::OM_CLASS;
  }
