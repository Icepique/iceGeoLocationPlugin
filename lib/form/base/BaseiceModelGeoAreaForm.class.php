...
/**
 * iceModelGeoArea form base class.
 *
 * @method iceModelGeoArea getObject() Returns the current form's model object
 *
 * @package    ##PROJECT_NAME##
 * @subpackage form
 * @author     ##AUTHOR_NAME##
 */
abstract class BaseiceModelGeoAreaForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ice_model_geo_area[%s]');
